...
const SilentTypingSettingsIcon: IconComponent = ({ width = 24, height = 24, className }) => (
...
export default definePlugin({
    name: "SilentTyping",
    authors: [Devs.Ven, Devs.Rini, Devs.D3SOX, FemcordDevs.Blue],
    ...
    start: () => addChatBarButton("SilentTyping", SilentTypingToggle, SilentTypingSettingsIcon),
