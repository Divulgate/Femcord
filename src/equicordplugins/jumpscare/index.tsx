...
const settings = definePluginSettings({
    imageSource: {
        ...
        default: "https://github.com/pastelrbx/Fembored/blob/main/icons/jumpscare/troll.gif?raw=true"
    },
    audioSource: {
        type: OptionType.STRING,
        description: "Sets the audio url of the jumpscare",
        default: "https://github.com/pastelrbx/Fembored/raw/main/sounds/jumpscare/trollolol.mp3?raw=true"
    },
    chance: {
