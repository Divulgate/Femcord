...
export const DISCORD_SETTINGS_ROUTES: SettingsRoute[] = [
    ...
    { route: "equicord_main", label: "Femcord", keywords: ["vencord"] },
    { route: "equicord_plugins", label: "Femcord Plugins", keywords: ["plugins"] },
    { route: "equicord_themes", label: "Femcord Themes", keywords: ["themes", "css"] },
    { route: "equicord_updater", label: "Femcord Updater", keywords: ["update"] },
    { route: "equicord_changelog", label: "Femcord Changelog", keywords: ["changelog", "news"] }
];
