...
export const actions: ButtonAction[] = [
    { id: "openEquicordSettings", label: "Open Femcord tab", callback: async () => await SettingsRouter.openUserSettings("equicord_main_panel"), registrar: "Equicord" },
        ...
        id: "checkForUpdates", label: "Check for Updates", callback: async () => {
            ...
            if (isOutdated) {
                setTimeout(() => showNotification({
                    title: "A Femcord update is available!",
